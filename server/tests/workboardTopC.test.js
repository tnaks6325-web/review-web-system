...
/* 현영 대상 내부 화면은 세 갈래를 한눈에 구분해야 하므로 칸 제목과 장수를 함께 그린다.
   업체·현영 비대상은 종전 두 칸을 유지하며 제목행도 만들지 않는다. */
t('★ 현영 대상 내부 화면에서만 칸 머리와 장수 배지를 그린다',
  /const label=showReceipt\?/.test(r2) && /class="rv2label"/.test(r2) && /class="cnt">\$\{n\}/.test(r2)
