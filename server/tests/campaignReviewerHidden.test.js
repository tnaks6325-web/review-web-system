...
ok('관리자 대시보드에 [🧪 테스트 공고] 버튼', /onclick="openTestCampaignModal\(\)"/.test(adminHtml));
ok('통합 작업대에도 버튼(편집 권한자에게만)', /STATE\.canEdit\?'<button class="btn" onclick="openTestCampaignModal\(\)"/.test(workdesk));
