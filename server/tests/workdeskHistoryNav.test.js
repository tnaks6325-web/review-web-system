/**
 * workdeskHistoryNav.test.js — 리뷰웹시스템[3버전] 뒤로/앞으로(SPA 히스토리) 회귀가드.
 *
 * 문제였던 것: 업체관리에서 어떤 업체의 작업을 클릭하면 화면이 통째로 작업보드로 바뀌는데
 *   히스토리에 아무것도 쌓이지 않아 **브라우저 뒤로가기가 리뷰웹시스템[3버전]을 벗어나** 버렸다
