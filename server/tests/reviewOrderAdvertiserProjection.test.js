...
// ★ 원본 연결 로직은 서비스 한 곳으로 이관됐다(advertiserProjection.service) — 사본 금지.
const projection = fs.readFileSync(path.join(root, 'src', 'services', 'advertiserProjection.service.js'), 'utf8');
