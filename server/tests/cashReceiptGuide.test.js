...
/* ★ D안(2026-08-05): 발행확정은 배송완료·구매확정 후 0~3일 — 캡처는 확정 뒤 제출(필수 아님) */
ok('발행 내역 캡처 안내 문구(발행 확정 후 제출 · 구매양식 제출 필수 아님)',
  /발행 내역 캡처는 발행이 확정된 뒤/.test(wd) && /구매양식 제출 때 필수가 아니에요/.test(wd));
