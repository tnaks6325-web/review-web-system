...
function harness(){
 ...
 vm.createContext(ctx);for(const name of ['_identityAddressDifference','_identityIssues','_pointToIdentityField','_purchaseIdentityTarget','_purchasePrimaryAction','_syncSubmissionIdentityAction','_retrySubmissionIdentity','_renderIdentityMatchState','_hasIdentityMask','_cardIdentityForm','_manualConfirmIdentity','_invalidateIdentityApproval','_applyOrderInfoSuggestion','_prepareIdentityApprovals','applyCardAiResult'])vm.runInContext(fn(name),ctx);
