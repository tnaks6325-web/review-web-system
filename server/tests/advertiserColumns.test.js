 ...
 * 원본 시트 컬럼은 순서 그대로 열고, 전화번호는 제공하되 참여자·은행·계좌번호·예금주만 전송 전에 제외한다.
...
assert.deepEqual(
  ...
  ['번호', '담당자', '구매일자', '인애드명단', '색상', '사이즈', '주문번호', '주문자제출',
    '수취인', '쿠팡id', '연락처', '주소', '결제금액', '리뷰제출', '입금', '비고(닉네임)', '택배송장', '기타 안내'],
  '원본 순서를 유지하며 참여자·금융정보만 제외한다',
);

for (const blocked of ['참여자', '은행', '계좌번호', '예금주']) {
...
]), [' 연락처 ', '전화번호', '핸드폰', '휴대폰', 'phone', '비고'], '전화번호 별칭은 제공하고 참여자·금융정보 별칭은 제외한다');
