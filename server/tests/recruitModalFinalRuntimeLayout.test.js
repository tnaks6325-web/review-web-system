...
['workdesk', 'admin'].forEach((surface) => {
  ...
  assert(html.includes('js/campaign-cards.js?v=20260817-popular-instant-c117'), `${surface} should request the released card asset.`);
  assert(html.includes('js/index-recruit.js?v=20260817-popular-instant-c117'), `${surface} should request the released controller asset.`);
});
