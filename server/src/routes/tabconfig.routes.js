    ...
    for (const sid of sheetIds) {
      ...
      for (const dbTab of dbTabs) {
        ...
        if (!tabExistsInSheet && campaignExistsAsTab) {
          ...
          //    3) campaign_name이 NULL/빈값이면 채워야 함
          ...
          const campIsEmpty = !dbCampaignName && correctCampaignName;
          const campNeedsFix = (campIsAnotherTab || campIsSelfTabName || campIsEmpty) && correctCampaignName && dbCampaignName !== correctCampaignName;
