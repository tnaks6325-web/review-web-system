...
const INSPECT_MSG_KINDS = [
  ...
  {
    key: 'receipt_validation', label: '🧾 현금영수증 검수 필요',
    desc: '현금영수증 확인 실패·판정 불가 건을 [✕ 불량]으로 처리했을 때',
    def: '제출하신 현금영수증 캡처를 확인하지 못했습니다.\n\n사유: {reason}\n\n'
      + '발행 완료된 현금영수증 화면을 다시 캡처해 제출해 주세요. 착오가 있다면 이 채팅으로 알려주세요.',
  },
  {
