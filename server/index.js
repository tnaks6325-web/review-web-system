...
const REQUIRED_SCHEMA = [
  ...
  // 134 — 복합 작업(옵션 있는 상품 + 없는 상품)의 선택 단위·선택지별 유입가이드.
  //   넷 다 옵션 저장 INSERT 한 문장에 들어가므로 하나라도 없으면 **공고 발행·수정의 옵션 저장이 전면 42703**.
  ['campaign_options', 'product_name'],
  ['campaign_options', 'unit_kind'],
