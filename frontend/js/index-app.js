...
function collectCurrentLayout() {
  ...
  // 컬럼 너비 수집
  const colWidthKeys = [
    'closedcb', 'tabname', 'capture', 'folder', 'round', 
...
// ─────────────────────────────────────────────────────────────
function _buildTabRowHtml(t, tabKey, false, isClosedTab, tabNameHtml, startDateHtml, tRate, stateHtml, tcAttr, roundLabel, endDateHtml) {
  // 각 열 셀 값 (없으면 회색 dash)
