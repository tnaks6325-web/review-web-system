/* ══════════════════════════════════════════════════════════════
   ...
   ★ 함수명·본문은 한 글자도 바꾸지 않았다 — 생성 HTML 안의 onclick 문자열
     (csSendReply·csSaveMemo·csToggleStatus·csViewImage·csOpenConversation…)과
