...
(function () {
  ...
  function render() {
    ...
    root.innerHTML = `<div class="wdcsmini" aria-label="이 작업의 C/S 대화">`+
      `<div class="wdcsmini-head"><span><i></i>C/S 대화</span><button type="button" data-open-cs>전체보기 ↗</button></div>`+
    ...
    if (full) full.addEventListener('click', () => { if (typeof window.switchView === 'function') window.switchView('cs'); });
