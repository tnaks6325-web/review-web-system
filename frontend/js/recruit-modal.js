...
#recruitModal .rf-compact-main .work-compose{display:grid;grid-template-columns:minmax(0,2fr) minmax(86px,1fr);gap:6px;align-items:stretch;width:100%}.rf-compact-main .work-compose textarea{width:100%;min-width:0;height:58px!important}.rf-compact-main .work-image-strip{width:auto;min-width:0;min-height:58px;border:1px dashed #C9D6E8;border-radius:6px;background:#FBFCFE}.rf-compact-main .ig-strip{height:58px;padding:4px}.rf-compact-main .advanced{margin-top:8px;border:1px solid #DCE3EC;border-radius:8px;background:#FBFCFE}.rf-compact-main .advanced summary{padding:9px 11px;color:#58667D;font-size:10px;font-weight:850;cursor:pointer}
