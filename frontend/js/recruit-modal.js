        ...
        <div>
          ...
          <div id="rf_review_mix" style="display:none;margin-top:7px;padding:8px 9px;border:1px solid var(--border,#E2E8F0);border-radius:7px;background:var(--bg,#F8FAFC)">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:6px;font-size:.72rem">
              <strong style="color:var(--t1,#1E293B)">상품 옵션별 리뷰 인원</strong>
              <span id="rf_review_mix_total" style="color:var(--t3,#64748B)">합계 0명 · 총인원 0명</span>
            </div>
            <div id="rf_review_mix_rows"></div>
          </div>
        ...
        <section class="editor">
          ...
          <div id="editorScroller" class="compact-editor-scroller" tabindex="0" aria-label="모집공고 수정 항목">
            ...
            <section class="section" data-sec="prod" data-part-only>
              ...
              <div class="row-form"><div class="form-row"><span class="form-label">리뷰 타입</span><div class="form-control"><div id="rf_review_type_btns" class="square-toggle"><button class="rchan-btn" data-group="review_type" data-val="" onclick="selectRfBtn('review_type',this)">자율리뷰</button><button class="rchan-btn" data-group="review_type" data-val="photo" onclick="selectRfBtn('review_type',this)">포토</button><button class="rchan-btn" data-group="review_type" data-val="text" onclick="selectRfBtn('review_type',this)">텍스트</button><button class="rchan-btn" data-group="review_type" data-val="confirm" onclick="selectRfBtn('review_type',this)">구매확정</button><button class="rchan-btn" data-group="review_type" data-val="star" onclick="selectRfBtn('review_type',this)">별점</button><button class="rchan-btn" data-group="review_type" data-val="mixed" onclick="selectRfBtn('review_type',this)">혼합</button></div><input id="rf_review_type" type="hidden"><div id="rf_mixed_review_composer" class="mixed-review-composer" hidden><div id="rf_review_mix"><div id="rf_review_mix_rows"></div><span id="rf_review_mix_total" hidden></span></div></div></div></div></div>
