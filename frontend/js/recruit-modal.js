...
#recruitModal .rf-compact-main .product-link-button{display:grid;place-items:center;flex:0 0 26px;width:26px;height:26px;border:1px solid #D5DDE8;border-radius:6px;background:#fff;color:#2563EB;transition:border-color .16s ease,background-color .16s ease,box-shadow .16s ease,transform .16s ease}.rf-compact-main .thumb-product-link:hover{border-color:#2563EB;background:#EFF6FF;box-shadow:0 1px 4px rgba(37,99,235,.2);transform:translateY(-1px)}.rf-compact-main .thumb-product-link:focus-visible{outline:2px solid #93C5FD;outline-offset:2px}.rf-compact-main .thumb-url-control input[type=file]{display:none}.rf-compact-main .thumb-guide-row .form-control{color:#7F8A9B;font-size:11px}
#recruitModal .rf-compact-main .rf-thumb-preview-wrap{display:inline-flex;align-items:center;gap:4px;min-width:0;padding:2px 4px;border:1px solid #D5DDE8;border-radius:6px;background:#F8FAFC;color:#64748B;font-size:9px;font-weight:800}.rf-compact-main .rf-thumb-preview-wrap img{width:30px;height:30px;object-fit:cover;border-radius:4px;background:#fff}.rf-compact-main #rf_thumb_preview_state{display:block;line-height:1.15;text-align:center;white-space:pre-line}.rf-compact-main .rf-thumb-preview-wrap.is-error{border-color:#FCA5A5;background:#FEF2F2;color:#B91C1C}
...
/* 🔗 이 옵션 전용 유입가이드 — 행 아래 항상 보이는 얇은 안내줄(클릭 대상임이 글자로 드러난다) */
#recruitModal .rf-unit>.rf-ug-cta{display:flex;align-items:center;gap:5px;width:100%;padding:4px 8px;
  border:0;border-bottom:1px solid #E9EEF5;background:#FBFCFE;color:#5D6B80;font:inherit;font-size:.62rem;
  font-weight:750;line-height:1;cursor:pointer;text-align:left;transition:background-color .14s ease,color .14s ease}
#recruitModal .rf-unit>.rf-ug-cta:hover{background:#EFF3F8;color:#2563C8}
#recruitModal .rf-ug-cta-ic{flex:none;font-size:.7rem}
#recruitModal .rf-ug-cta-tx{flex:none;color:#45536A;font-weight:850}
#recruitModal .rf-ug-cta-st{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#94A3B8}
#recruitModal .rf-ug-cta-ar{flex:none;color:#94A3B8;font-size:.6rem;transition:transform .16s ease}
